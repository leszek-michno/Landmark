...
const OfferBronze = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute w-full h-full backface-hidden flex items-center justify-center rounded-lg shadow-lg bg-amber-950 flex-col 
              border-t-[0.02rem]
              border-l-[0.02rem]
              border-b-[0.02rem]
              border-r-[0.02rem]
              ...
              border-b-yellow-500
              border-r-red-500">
          <h2 className="text-2xl text-amber-200 font-serif m-2 text-center">
            {t("offer.bronze_title")}
          </h2>
          <h2 className="text-2xl text-amber-200 font-serif m-2 text-center">
            {t("offer.bronze_tier")}
          </h2>
